        ...
        <Route element={<Layout />}>
          <Route path="/configuracion" element={<Outlet />}>
            ...
            <Route path="cajero" element={<Outlet />}>
              ...
              />
              <Route
                path="tarjetas/update/:id"
                element={<TarjetaEdit title={"Modificar Tarjeta"} />}
              />
              <Route
                path="tarjetas/update-estado/:id"
                element={
                  <TarjetaEditEstado title={"Modificar Estado de Tarjeta"} />
                }
              />
              <Route path="asignar-ip" element={<IndexAsignarIP />} />
              <Route path="asignar-ip/asignar/:id" element={<AsignarIP />} />
              <Route path="4" element={<IndexConfiguracion />} />
              <Route path="5" element={<IndexTorpedo />} />
              <Route path="torpedo/create" element={<Torpedo />} />
              <Route path="6" element={<IndexSolapinPerdido />} />
              <Route
                path="solapin-perdido/asociar"
