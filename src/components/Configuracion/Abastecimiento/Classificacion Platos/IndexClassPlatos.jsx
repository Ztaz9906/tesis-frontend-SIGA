...
import { getList, getListWithSearch, remove } from '../../../../services/Configuracion/Abastecimiento/ClassificacionPlatos';
                                ...
                                <TableRow key={row.id_clasificacion_plato} className='hover:bg-gray-200'>
                                    ...
                                    <TableCell>
                                        <div className='flex flex-row text-center items-center'>
                                            <Link
                                                to={`/Configuracio/clasificacion_platos/update/${row.id_clasificacion_plato}`}
                                                className={`mx-5 `}
